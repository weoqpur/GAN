...
def train_lr_transfrom(crop_size, upscale_factor):
    return Compose([
        ToPILImage(),
...
class TrainDataset(Dataset):
    def __init__(self, data_dir, crop_size, upscale_factor):
        ...
        self.hr_transform = train_hr_transfrom(crop_size)
        self.lr_transform = train_lr_transfrom(crop_size, upscale_factor)
